...
exports.registrationUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        const html = await ejs_1.default.renderFile(node_path_1.default.join(__dirname, "../mails/activation-mail.ejs"), data);
        try {
            ...
            res.status(201).json({
                success: true,
                message: `Please check your email: ${user.email} to activate your accout`,
...
exports.updateUserInfo = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (email) {
            const isEmailExist = await user_model_1.default.findOne({ email });
            if (isEmailExist &&
                isEmailExist._id.toString() !== userId.toString()) {
                return next(new ErrorHandler_1.default("Email already exist", 400));
            }
            user.email = email;
        }
